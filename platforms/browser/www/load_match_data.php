...
$i++;
	...
	$teamid=explode(',',$teamid);
			...
			$posts1[] = array('matchid2'=>$matchid,'trnid2'=>$trnid,'teamid3'=>$teamid[0],'teamid4'=>$teamid[1],'start_time1'=> $start_time,'team3'=> $team[0],'team4'=> $team[1],'logo3'=> $logo[0],'logo4'=> $logo[1],'counts1'=>$j); 
			//$posts1[] = array('start_time'=> $start_time, 'team1'=> $team[0],'team2'=> $team[1],'logo1'=> $logo[0],'logo2'=> $logo[1],'counts'=>$i); 
...
$j++;
	...
	$teamid=explode(',',$teamid);
			...
			$posts2[] = array('matchid3'=>$matchid,'trnid3'=>$trnid,'teamid5'=>$teamid[0],'teamid6'=>$teamid[1],'start_time2'=> $start_time,'team5'=> $team[0],'team6'=> $team[1],'logo5'=> $logo[0],'logo6'=> $logo[1],'counts2'=>$k); 
			//$posts1[] = array('start_time'=> $start_time, 'team1'=> $team[0],'team2'=> $team[1],'logo1'=> $logo[0],'logo2'=> $logo[1],'counts'=>$i); 
