...
$query1="select * from inet_contest_join where cust_id='$userid' and contest_id='$contestid' and status='Y'";
...
$query="INSERT INTO inet_contest_join(cust_id,cust_team_id,contest_id) VALUES ('$userid','$userteamid','$contestid')";
